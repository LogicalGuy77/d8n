...
import { sendERC20Token, sendNativeToken } from "../workflow_executor/assetSender.js";
...
export class sendTokenNode implements Node {
    ...
    constructor(id: string, label: string, tokenAddress: string, destination: string, amount: string){
        this.id = id;
        this.label = label;
        if(tokenAddress){
